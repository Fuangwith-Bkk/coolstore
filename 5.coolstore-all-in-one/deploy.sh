...
oc annotate dc/inventory app.openshift.io/connects-to=inventory-database  -n coolstore-shop
...
### 
oc annotate dc/coolstore app.openshift.io/connects-to=catalog-springboot,coolstore-postgresql --overwrite -n coolstore-shop 
oc annotate dc/catalog-springboot app.openshift.io/connects-to=inventory,catalog-database --overwrite -n coolstore-shop 
